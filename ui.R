...
SVMs are based on two key ideas:  "),
                ...
                h4("The notion of maximum margin") ,
                 h4("The notion of kernel function"),
...
classified but below the margin if they are between 0 and 1, or even poorly classified, if they exceed 1.
    ...
    # model comparision
    tabPanel("VII.Model Comparison on test sample",
             
             h4("We compare the performance of our model on the test sample
                which is not used for model implementation"),
        
             br(),
             h4("ROC Curves encapsulate the exchange between the true positive rate(sensitivity) and false positive rate(1-specificity) for a predictive model using different probability thresholds.
                "),
             br(),
             h4("ROC curves are compatible when the observations are balanced between each class, whereas precision-recall curves are suitable for imbalanced datasets."
                ),
             ...
             h4("	Precision-Recall curves outline the trade-off between the true positive rate and the positive predictive value for a predictive model using different probability thresholds."
             ),
             ...
             h4("Precision-Recall is a practical measure of success of prediction when the classes are very imbalanced. In information recovery, precision is a measure of result relevancy, while recall is a measure of how many truly relevant results are returned."),
             br(),

              h4("The precision-recall curve points out the tradeoff between precision and recall for different threshold. A high area under the curve represents both high recall and high precision, where high precision relates to a low false positive rate, and high recall relates to a low false negative rate."),
             br(),
             h4("High scores for both show that the classifier is returning accurate results (high precision), as well as returning a majority of all positive results (high recall). "),
